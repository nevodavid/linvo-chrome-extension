...
export enum UserActionsEnum {
    ...
    CHANGE_INJECT_STATE = 'CHANGE_INJECT_STATE',
}
...
export class UserActions {
    ...
    static changeInjectState(): setInject<UserActionsEnum.CHANGE_INJECT_STATE> {
        return {
            type: UserActionsEnum.CHANGE_INJECT_STATE
        };
    }
    ...
    static changeInject() : any {
        return (dispatchEvent: any): any => {
            return dispatchEvent(UserActions.changeInjectState());
        }
    }
